...
<section class="col-lg-12"  id="tab" >
    ...
    <h3 style="text-align:center;font-family: Bahnschrift;margin-top:-5px;margin-bottom:-10px;">LISTE DES UTILISATEURS</h3>
    <hr style="background-color:#106eea; height:2px;">
            ...
            <div class="modal-body">
             ...
             <div class="form-group">
                <div class="inputWithIcon">
                    <label>Nom</label>
                    <input type="text"  class="form-control NOMSEC" name="NOMSEC" placeholder="Entrer votre nom" ><span id="nomsec"  class="alert"></span>
                ...
                <div class="inputWithIcon">
                    <label>Email</label>
                    <input type="text" id="EMAIL" class="form-control EMAIL" name="EMAIL" placeholder="Entrer votre email"><span id="email" class="alert"></span>
                ...
                <div class="inputWithIcon">
                    ...
                    <input type="text"   class="form-control MDP" name="MDP" placeholder="Mot de passe"><span id="mdp" class="alert"></span>
                ...
                <div class="inputWithIcon">
                    ...
                    <input type="text" class="form-control MDP1" name="MDP" placeholder="Confirmation mot de passe"><span id="mdp1" class="alert"></span>
                    <a class="user-btn" href="#"><i class="fas fa-lock"></i></a>
                </div>
                </div>
